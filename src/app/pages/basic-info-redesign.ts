...
function injectStyles(): void {
  ...
  style.textContent = `
    .bi-page { background:var(--sb-c-f5f7fa, #F5F7FA); padding:24px; min-height:calc(100vh - 140px); box-sizing:border-box; font-family:"Hiragino Sans","Noto Sans JP",sans-serif; }
    ...
    .bi-section { background:var(--sb-c-ffffff, #FFFFFF); border:1px solid var(--sb-c-e6e8ec, #E6E8EC); border-radius:12px; padding:20px 22px; box-shadow:0 1px 3px rgba(0,0,0,.04); }
    ...
    .bi-sec-title { font-size:15px; font-weight:700; color:var(--sb-c-1a2233, #1A2233); }
    ...
    .bi-url-copy { flex-shrink:0; padding:0 14px; font-size:12.5px; font-weight:600; color:var(--sb-accent, #0091FF); background:#eaf5ff; border:1px solid #cde6ff; border-radius:8px; cursor:pointer; white-space:nowrap; }
    .bi-url-copy:hover { background:#dcefff; }
    .bi-url-param { align-self:flex-start; padding:7px 14px; font-size:12.5px; font-weight:600; color:#48526b; background:var(--sb-c-ffffff, #FFFFFF); border:1px solid #d6dae1; border-radius:8px; cursor:pointer; }
    .bi-url-param:hover { background:var(--sb-c-f5f7fa, #F5F7FA); }
    ...
    .bi-toggle-track::after { content:""; position:absolute; top:2px; left:2px; width:20px; height:20px; border-radius:50%; background:var(--sb-c-ffffff, #FFFFFF); box-shadow:0 1px 2px rgba(0,0,0,.2); transition:transform .15s; }
    .bi-toggle input:checked + .bi-toggle-track { background:var(--sb-accent, #0091FF); }
    .bi-toggle input:checked + .bi-toggle-track::after { transform:translateX(20px); }
    .bi-submit { align-self:flex-start; display:inline-flex; align-items:center; margin-top:2px; padding:11px 26px; font-size:14px; font-weight:700; color:#FFFFFF; background:var(--sb-accent, #0091FF); border:none; border-radius:10px; cursor:pointer; box-shadow:0 2px 6px rgba(0,145,255,.3); font-family:inherit; }
    .bi-submit:hover { background:#007ee0; }
    /* 右: 要約パネル */
    .bi-right { position:sticky; top:16px; }
    .bi-summary { background:var(--sb-c-ffffff, #FFFFFF); border:1px solid var(--sb-c-e6e8ec, #E6E8EC); border-radius:12px; padding:18px 18px 16px; box-shadow:0 1px 3px rgba(0,0,0,.04); }
    .bi-sum-title { font-size:14px; font-weight:700; color:var(--sb-c-1a2233, #1A2233); }
    .bi-sum-sub { font-size:11.5px; color:#8A94A6; margin-top:2px; }
    .bi-sum-head { margin-bottom:14px; }
    .bi-sum-group { padding:12px 0; border-top:1px solid var(--sb-c-eef0f3, #EEF0F3); }
    .bi-sum-group:first-child { border-top:none; padding-top:0; }
    .bi-sum-gtitle { display:flex; align-items:center; gap:6px; font-size:12.5px; font-weight:700; color:var(--sb-c-2f3a4d, #2F3A4D); margin-bottom:8px; }
    ...
    .bi-sum-v { color:var(--sb-c-1a2233, #1A2233); text-align:right; word-break:break-all; font-weight:500; }
