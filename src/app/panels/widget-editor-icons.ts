...
/** 配置（左揃えの線＋下向きの印＝押すと選ぶ小窓が出る） */
export function svgToolAlign(): string {
  return `<svg width="22" height="14" viewBox="0 0 22 14" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><line x1="1" y1="2.5" x2="12" y2="2.5"/><line x1="1" y1="5.5" x2="9" y2="5.5"/><line x1="1" y1="8.5" x2="12" y2="8.5"/><line x1="1" y1="11.5" x2="9" y2="11.5"/><path d="M16 6l2.5 2.5L21 6" stroke-width="1.2"/></svg>`
}
/** 斜体 (I) */
...
/** 背景色 (A + 黄色のバー。文字色と同じ形で、バーの色だけ違う) */
export function svgToolBgColor(): string {
  return `<svg width="14" height="14" viewBox="0 0 14 14"><path d="M3.5 10L7 2l3.5 8" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/><line x1="4.8" y1="8" x2="9.2" y2="8" stroke="currentColor" stroke-width="1.2"/><rect x="2" y="12" width="10" height="2" rx=".5" fill="#f5c400"/></svg>`
}
/** 画像 */
