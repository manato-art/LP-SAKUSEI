    ...
    host.append(
      ...
      stepList([
        { title: '見本を選んで「追加」を押す', note: 'LPに入ったうえで、そのまま編集画面が開きます。' },
        {
          ...
          note: '左の画面で文字を直接書き換え、右のカードで色や大きさを変えます。よくある質問や口コミのように並んでいる部品は、増やしたり消したりもできます。',
        },
        {
...
/** 作り方のタブ（足していく） */
const TABS: NocodeTab[] = [SAMPLE_TAB]

/** 別の作り方を足す（型から作る・部品を積んで作る） */
export function registerNocodeTab(tab: NocodeTab): void {
