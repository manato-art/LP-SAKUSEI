...
/** 既定の配信Version幅（実物のデフォルト。プレビュー delivery-preview.ts も同じ幅） */
export const DELIVERY_WIDTH = 620

/** 本文の画像リンク（配信LPは計測URLへも送る・delivery-image-links.ts） */
const IMAGE_LINK_SCRIPT = imageLinkScript(true)
